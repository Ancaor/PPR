...
public:
    ...
    // compara un nodo con otro, devuelve true si el nodo es mejor que el otro
    inline bool esMejor(tNodo & otro){
      return (ci() < otro.ci());
    }
...
/************************************************************************/
// Funciones de equilibrado dinámico de carga y difusion de cota
void EquilibrarCarga(tPila & pila, bool & fin, tNodo & sol);
