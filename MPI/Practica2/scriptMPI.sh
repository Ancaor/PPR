...
echo "OMP1D para 4 threads:" >> $ARCHIVO
...
echo "OMP1D para 9 threads:" >> $ARCHIVO
...
echo "OMP2D para 4 threads:" >> $ARCHIVO

./bin/floydOMP2D ./input/input60 4 >> $ARCHIVO
./bin/floydOMP2D ./input/input240 4 >> $ARCHIVO
./bin/floydOMP2D ./input/input750 4 >> $ARCHIVO
./bin/floydOMP2D ./input/input1200 4 >> $ARCHIVO

echo "OMP2D para 9 threads:" >> $ARCHIVO

./bin/floydOMP2D ./input/input60 9 >> $ARCHIVO
./bin/floydOMP2D ./input/input240 9 >> $ARCHIVO
./bin/floydOMP2D ./input/input750 9 >> $ARCHIVO
./bin/floydOMP2D ./input/input1200 9 >> $ARCHIVO